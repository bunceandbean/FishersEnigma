  ...
  <area target="_blank" alt="" title="" href = "bs.html" shape = "circle" class = "area">
   ...
   $("area").on("click", function(e){
    ...
    document.querySelector("area").onclick = "display()";
           ...
           document.querySelector("area").coords = "" + $(window).width() * .32 + "," + $(window).height() *.5486 + ", 20";
           function display(){
             document.querySelector("title").textContent = "hes a dr."
             alert("His most notable title...");
             document.querySelector("title").textContent = "First name: new name of Tsunemi Yonehachi shop"
